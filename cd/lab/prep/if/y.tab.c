...
{
  "$end", "error", "$undefined", "IF", "COND", "OB", "CB", "OFB", "CFB",
  "$accept", "S", YY_NULLPTR
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 8 "p.y" /* yacc.c:1646  */
    { (yyval) = (yyvsp[-1]) + 1; max = (yyval);}
#line 1207 "y.tab.c" /* yacc.c:1646  */
    break;

  case 3:
#line 9 "p.y" /* yacc.c:1646  */
    { (yyval) = 0; }
